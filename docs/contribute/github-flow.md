<!-- Space: Projects -->
<!-- Parent: Hammerspoon -->
<!-- Title: Contributing GithubFlow Hammerspoon -->
<!-- Label: Hammerspoon -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to hammerspoon project on [GitHub](https://github.com/luismayta/hammerspoon), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/hammerspoon/pulls).
...
To follow the instructions in this guide and start contributing to hammerspoon project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/hammerspoon.git
```

Now your **upstream** points to **luismayta/hammerspoon**.
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/hammerspoon/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
